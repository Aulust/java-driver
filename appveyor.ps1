...
$maven_base = "C:\Users\appveyor\maven"
$maven_path = "$($maven_base)\apache-maven-3.3.9"
If (!(Test-Path $maven_path)) {
  $maven_url = "https://www.dropbox.com/s/y1quan8wrj7n63z/apache-maven-3.3.9-bin.zip?dl=1"
  $maven_zip = "C:\Users\appveyor\apache-maven-3.3.9-bin.zip"
